        ...
        const selectTxs = (transaction) => {
            ...
            R.forEach((txOutput) => {
                if (address && txOutput.address == address) {
                    txOutputs.push({
                        ...
                        studentId: transaction.studentId, // Include studentId
                        eventId: transaction.eventId, // Include eventId
                        timestamp: transaction.timestamp // Include timestamp
                    });
                }
                index++;
            ...
            R.forEach((txInput) => {
                ...
                txInputs.push({
                    ...
                    studentId: txInput.studentId, // Include studentId
                    eventId: txInput.eventId, // Include eventId
                    timestamp: txInput.timestamp // Include timestamp
                });
            }, transaction.data.inputs);
        };
