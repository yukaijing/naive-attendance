...
*/
class Transaction {
    constructor(type, studentId = null, publicKey = null, eventId = null) {
        this.id = null;
        this.hash = null;
        this.type = type;
        this.data = {
    ...
    check() {
        ...
        } else if (this.type === 'create_event_wallet') {
            if (!this.data.eventId || !this.data.publicKey) {
                console.error(`Invalid create_event_wallet transaction: missing eventId or publicKey`);
                throw new TransactionAssertionError(`Invalid create_event_wallet transaction: missing eventId or publicKey`, this);
            }
