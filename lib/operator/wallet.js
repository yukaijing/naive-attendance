...
class Wallet {
    ...
    generateAddress() {
        ...
        return { publicKey: newKeyPair.publicKey, privateKey: newKeyPair.secretKey };
    }
    ...
    static fromPassword(password, studentId) {
    ...
    getWalletIdByAddress(address) {
        let keyPair = this.keyPairs.find(keyPair => keyPair.publicKey === address);
        return keyPair ? this.id : null;
    }
}
